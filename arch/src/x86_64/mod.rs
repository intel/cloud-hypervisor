...
pub enum Error {
    ...
    // xxx: todo
    CpuidHypervisor(HypervisorError),
    ...
    /// Error checking CPUID compability
    CpuidCheckCompability,
}
...
impl CpuidFeatureEntry {
    ...
    pub fn check_cpuid_compatibility(
        ...
        // Loop on feature bit and check if the 'source vm' feature is a subset of those of the 'destination vm' feature
        ...
        if compatible {
            ...
            Err(Error::CpuidCheckCompability)
        }
    }
}
...
pub fn generate_common_cpuid(
    ...
    // Supported CPUID
    let mut cpuid = hypervisor.get_cpuid().map_err(Error::CpuidHypervisor)?;
